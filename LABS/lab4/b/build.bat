...
echo [1/3] Компиляция: headers.cpp...
cl /nologo /EHsc /c headers.cpp /Fo:build/headers.obj /I.
if %errorlevel% neq 0 goto error

echo [2/3] Компиляция: calculation.cpp...
cl /nologo /EHsc /c calculation.cpp /Fo:build/calculation.obj /I.
if %errorlevel% neq 0 goto error
...
link /nologo build/main.obj build/headers.obj build/calculation.obj /OUT:main.exe
if %errorlevel% neq 0 goto error
